...
;(function (factory) {
  ...
  var S2 = (function () {
        ...
        ;(function (undef) {
          ...
          requirejs = require = req = function (
            ...
            if (forceSync) {
              ...
              //Using a non-zero value because of concern for what old chromes
              //do, and latest chromes "upgrade" to 4 if lower value is used:
    ...
    S2.define(
      ...
      function ($, Utils, KEYS) {
        ...
        Search.prototype.bind = function (decorated, container, $container) {
          ...
          // Workaround for chromes which do not support the `input` event
          // This will prevent double-triggering of events for chromes which support
    ...
    S2.define('select2/dropdown/tagsSearchHighlight', ['../utils'], function (
      Utils
    ) {
    ...
    S2.define('select2/options', ['jquery', './defaults', './utils'], function (
      $,
      Defaults,
      Utils
    ) {
    ...
    ;(function (factory) {
      if (typeof S2.define === 'function' && S2.define.amd) {
        ...
        // Node/CommonJS style for chromeify
      ...
      function shouldAdjustOldDeltas (orgEvent, absDelta) {
        ...
        // then we are assuming that the chrome is treating this as an
        // older mouse wheel event and that we should divide the deltas
        // by 40 to try and get a more usable deltaFactor.
        // Side note, this actually impacts the reported scroll distance
        // in older chromes and can cause scrolling to be slower than native.
